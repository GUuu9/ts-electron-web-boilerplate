...
- **com.apple.security.device.bluetooth**: 블루투스 장치 검색 및 연결 시 필수.
- **com.apple.security.device.usb**: USB 및 HID 장치 통신 시 필수.
- **com.apple.security.device.audio-input**: 마이크 및 오디오 입력 스트림 획득 시 필수.
- **com.apple.security.cs.allow-jit**: Electron의 V8 엔진 최적화를 위해 필수.
